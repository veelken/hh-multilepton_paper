...
\begin{figure}
  \centering\includegraphics[width=\cmsFigWidth]{plots/postFitPlots/2lss.pdf}
  \centering\includegraphics[width=\cmsFigWidth]{plots/postFitPlots/3l.pdf}
  \centering\includegraphics[width=\cmsFigWidth]{plots/postFitPlots/4l.pdf}
  \caption{
...
\begin{figure}
  \centering\includegraphics[width=\cmsFigWidth]{plots/postFitPlots/3l_1tau.pdf}
  \centering\includegraphics[width=\cmsFigWidth]{plots/postFitPlots/2l_2tau.pdf}
  \centering\includegraphics[width=\cmsFigWidth]{plots/postFitPlots/1l_3tau.pdf}
  \centering\includegraphics[width=\cmsFigWidth]{plots/postFitPlots/0l_4tau.pdf}
  \caption{
    Distribution in the output of the BDT for SM non-resonant $\HH$ production
